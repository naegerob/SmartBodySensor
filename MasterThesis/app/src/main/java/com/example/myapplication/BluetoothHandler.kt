...
class BluetoothConnectionHandler(private val context: Context) : BluetoothGattCallback() {
    ...
    companion object {
        ...
        val UUID_HEART_RATE_CHARACTERISTICS: UUID =
            UUID.fromString("00002A37-0000-1000-8000-00805F9B34FB")
        val UUID_HEART_RATE_DESCRIPTOR: UUID =
    ...
    override fun onCharacteristicChanged(
        ...
        if (characteristic.uuid == UUID_HEART_RATE_CHARACTERISTICS) {
            ...
            dataPresenterIntent.run {
                putExtra(KEY_TEMP_DATA, byteArray.contentToString())
    ...
    override fun onServicesDiscovered(gatt: BluetoothGatt, status: Int) {
        ...
        if (status == BluetoothGatt.GATT_SUCCESS) {
            ...
            val heartRateCharacteristic =
                heartRateService?.getCharacteristic(UUID_HEART_RATE_CHARACTERISTICS)
